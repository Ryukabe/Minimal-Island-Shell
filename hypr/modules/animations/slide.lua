...
hl.curve("alien",    { type = "bezier", points = { {1.2, 0}, {0.0, 1.4} } })
hl.curve("cat",      { type = "bezier", points = { {0.38, 0.04}, {1, 0.07} } })

-- Windows
hl.animation({ leaf = "windows",    enabled = true, speed = 3, bezier = "hobbyist", style = "popin" })
hl.animation({ leaf = "windowsIn",  enabled = true, speed = 3, bezier = "hobbyist", style = "popin" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 3, bezier = "hobbyist", style = "popin" })
...
-- Workspaces
hl.animation({ leaf = "workspaces", enabled = true, speed = 4, bezier = "alien", style = "slidefade 20%" })