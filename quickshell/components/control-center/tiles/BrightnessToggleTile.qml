...
Rectangle {
    ...
    Rectangle {
        ...
        width: Math.max(height, parent.width * (BrightnessService.muted ? 0 : BrightnessService.percent / 100))
        color: Colors.accent
        Behavior on width { NumberAnimation { duration: 100; easing.type: Easing.OutCubic } }
    }

    Text {
        text: BrightnessService.muted ? "volume_off" : "volume_up"
        ...
        MouseArea {
            ...
            onClicked: BrightnessService.toggleMute()
        }
    }
